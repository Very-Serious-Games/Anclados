...
public class BinaryNetSerializer : INetworkSerializer
{
    ...
    private MessageType GetMessageType(INetworkMessage message)
    {
        return message switch
        {
            ...
            StateAckMessage => MessageType.StateAck,
    ...
    private void SerializeMessage(BinaryWriter writer, INetworkMessage message)
    {
        switch (message)
        {
            ...
            case PlayerStateMessage state:
                ...
                writer.Write((ushort)state.stateSequence);
                break;
            ...
            case StateAckMessage ack:
                writer.Write((short)ack.playerId);
                writer.Write((ushort)ack.stateSequence);
                break;
    ...
    private INetworkMessage DeserializeMessage(BinaryReader reader, MessageType msgType)
    {
        switch (msgType)
        {
            ...
            case MessageType.PlayerState:
                ...
                msg.stateSequence = reader.ReadUInt16();
                return msg;
            ...
            case MessageType.StateAck:
                return new StateAckMessage(
                    reader.ReadInt16(),
                    reader.ReadUInt16()
                );
